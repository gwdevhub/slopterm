...
// Arrow keys for the mobile keyboard toolbar - the only keys there still drawn as glyphs
// (Ctrl/Alt/Tab/Esc and friends spell their own names out instead, see KeyboardToolbar).
